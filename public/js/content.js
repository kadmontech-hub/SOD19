...
export const elementDefinitions = [
  { key:'tierra', name:'Tierra', glyph:'◇', color:'#B89056', visual:visual('048'), placeholder:false, description:'Materia, cuerpo, límite, estructura y arraigo.' },
  { key:'agua', name:'Agua', glyph:'≈', color:'#2EA9E8', visual:visual('049'), placeholder:false, description:'Emoción, memoria, adaptación, vínculo y profundidad.' },
  { key:'viento', name:'Viento', glyph:'≋', color:'#A9E7E4', visual:visual('050'), placeholder:false, description:'Pensamiento, palabra, perspectiva, movimiento y posibilidad.' },
  { key:'fuego', name:'Fuego', glyph:'△', color:'#FF735A', visual:visual('022'), placeholder:true, description:'Voluntad, transformación, deseo, coraje y dirección.' },
  { key:'eter', name:'Éter', glyph:'Ø', color:'#9A70FF', visual:visual('023'), placeholder:true, description:'Conciencia, información, unidad, vacío y origen.' }
];
...
export const seeds = seedSpecs.map((s,i)=>({id:`seed-${i+1}`,number:i+1,title:s[0],interpretation:s[1],application:s[2],keywords:s[3],glyph:i%5===0?'Ø':elementDefinitions[i%5].glyph,element:elementDefinitions[i%5].key,image:[visual('056'),visual('057'),visual('027'),visual('041')][i%4],state:i<4?'discovered':'latent'}));

export const sampleCodes = [
  {id:'SOD-000001',title:'El momento en que distinguiste el hecho del miedo',type:'Comprensión',depth:'Fundacional',date:'Hoy',summary:'Una confusión dejó de ser una masa única y se convirtió en partes observables.',visual:visual('042'),linkedSeedIds:['seed-2']},
  {id:'SOD-000002',title:'La decisión que abrió un camino',type:'Decisión',depth:'Raro',date:'Hace 3 días',summary:'Elegiste una acción reversible en lugar de esperar una certeza imposible.',visual:visual('044'),linkedSeedIds:['seed-16']},
  {id:'SOD-000003',title:'Siete días sosteniendo una intención',type:'Hábito',depth:'Infrecuente',date:'Hace 2 semanas',summary:'La repetición dejó evidencia de una identidad que comenzaba a actualizarse.',visual:visual('043'),linkedSeedIds:['seed-4']}
];
